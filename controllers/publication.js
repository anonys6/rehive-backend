        ...
        let formatPublication = populatedPublication.map(publication => {
            return {
                ...
                author: {
                    ...
                    avatar: `${BASE_URL}/avatar/${publication.author.avatar}`,
                },
            };
        });
        ...
        if (savePublication) {
            ...
            return res.status(200).json({
                ...
                publication: {
                    ...
                    image: populatedPublication.image ? `${BASE_URL}/image/${populatedPublication.image}` : undefined,
                    ...
                    author: {
                        ...
                        avatar: `${BASE_URL}/avatar/${populatedPublication.author.avatar}`,
                    },
                },
            });
        } else {
